...
class TracedMessages:
    ...
    def _post(
        ...
        payload = {
            ...
            "cache_read_input_tokens": getattr(response.usage, "cache_read_input_tokens", 0) or 0 if response else 0,
            "cache_creation_input_tokens": getattr(response.usage, "cache_creation_input_tokens", 0) or 0 if response else 0,
            "latency_ms": latency_ms,
